        ...
        public void drawSelf(Canvas canvas) {
            switch (state) {
                case TODAY: // 今天
                    ...
                    canvas.drawRect((float) (mCellSpace * (i)), (float) ((j) * mCellSpace),(float) (mCellSpace * (i))+100,(float) ((j) * mCellSpace)+100,
                            mCirclePaint);
                    break;
